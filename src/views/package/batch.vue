...
<script lang="ts" setup>
  ...
  import { getBatch, deleteBatch, getBatchList, addBatch, updateBatch } from '/@/views/package/batchApi';
  ...
  const handleAdd = () => {
    ...
    addBatch(dataSource[counter]).then((res) => {
      console.log(res);
    });
  };
